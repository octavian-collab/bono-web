...
export default function GataDeStart() {
  return (
    <div className="ld-sec-wrap bg-page">
      <section className="ld-sec" style={{ paddingBlock: 0, paddingBottom: 92 }}>
        <div
          className="gata-de-start-inner"
          style={{
        ...
        >
          ...
          <div style={{ flex: '1 1 0', minWidth: 0 }}>
            <h2
              className="t-h1"
              style={{ color: '#fff', marginBottom: 20, letterSpacing: '-0.04em' }}
            >
              Gata de start?
            </h2>
            <p
              className="t-lead"
              style={{ color: 'rgba(255,255,255,0.80)', marginBottom: 40, maxWidth: 520 }}
            >
          ...
          {/* Right — phone mockup (add public/images/phone-mockup.png to enable) */}
        </div>
      </section>
    </div>
  )
